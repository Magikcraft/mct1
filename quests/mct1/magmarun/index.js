...
var QuestMCT1Magmarun = /** @class */ (function(_super) {
    ...
    QuestMCT1Magmarun.prototype.start = function() {
        ...
        ;[1, 2, 3, 4, 5].forEach(function(i) {
            ...
            world_1
                .worldly(world)
                .registerPlayerExitRegionEvent(key, function(event) {
                    _this.activeRuns = _this.activeRuns.filter(function(j) {
                        return j !== i
                    })
                    log('this.activeRuns', _this.activeRuns)
                })
    ...
    QuestMCT1Magmarun.prototype.activateRun = function(
        rows,
        dispenseType,
        interval
    ) {
                ...
                row.forEach(function(loc, j) {
                    ...
                    setTimeout(function() {
                        ...
                        if (dispenseType == 'LEGACY_FIREBALL') {
                            if (j % 4 === 0) {
                                _this
                                    .getBlocksInRadius(targetLoc, 5, ['FIRE'])
    ...
    QuestMCT1Magmarun.prototype.getBlocksInRadius = function(
        loc,
        radius,
        filterTypes
    ) {
